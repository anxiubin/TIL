...
const crawler = async () => {
    try {
        ...
        await page2.goto('https://mask.shopping/large', {waitUntil: 'load',timeout: 0}); //옵션 줘서 TimeoutError 해결
        ...
        const str2 = stringify(randomMaskResults); //이차원 배열을 문자열화 해서 새로운 csv 파일에 쓰기
